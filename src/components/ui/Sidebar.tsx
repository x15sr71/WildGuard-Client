...
const Sidebar: React.FC<SidebarProps> = ({ darkMode, setSelectedView }) => {
  return (
    <div className={`fixed top-0 left-0 w-64 h-screen ${darkMode ? 'bg-[#0F9D58]' : 'bg-green-100'} border-r ${darkMode ? 'border-green-600' : 'border-green-200'} transition-all duration-300 shadow-lg flex flex-col`}>
      <div className="p-4">
